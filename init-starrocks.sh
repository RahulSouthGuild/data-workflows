...
FE_CONTAINERS=("starrocks-fe-1" "starrocks-fe-2")
...
start_services() {
    ...
    $DOCKER_COMPOSE up -d starrocks-fe-1 starrocks-fe-2 starrocks-be-1 starrocks-be-2 starrocks-init
...
check_status() {
    ...
    $DOCKER_COMPOSE ps starrocks-fe-1 starrocks-fe-2 starrocks-be-1 starrocks-be-2
    echo ""
